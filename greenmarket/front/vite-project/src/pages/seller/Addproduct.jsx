...
const Addproduct = () => {
  ...
  return (
    ...
    <div className="no-scrollbar flex-1 h-[95vh] overflow-y-scroll flex flex-col justify-between">
            <form onSubmit={onSubmitHandler} className="md:p-10 p-4 space-y-5 max-w-lg cursor-pointer">
                <div>
                ...
                <div className="flex items-center gap-5 flex-wrap">
                    ...
                    <div className="flex-1 flex flex-col gap-1 w-32">
                        ...
                        <input onChange={(e)=>setOffer(e.target.value)} value={offerprice}    id="offer-price" type="number" placeholder="0" className="outline-none md:py-2.5 py-2 px-3 rounded border border-gray-500/40" required />
                    </div>
                </div>
                <button type='submit' className="px-8 py-2.5 bg-indigo-500 text-white font-medium rounded cursor-pointer">ADD</button>
            </form>
        </div>
