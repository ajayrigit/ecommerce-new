        ...
        <div className="px-6 md:px-16 lg:px-24 xl:px-32 mt-24 bg-green/10">
            <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-gray-500/30 text-gray-500">
                <div>
                    ...
                    <p className="max-w-[410px] mt-6">we delievr fresh groceries and snacks staraight to your door.Trusted by thousands ,we aim to make your shopping simpke and afforetable</p>
                </div>
